...
#define SWD_CLK_MODE PORTA_PCR12=PORT_PCR_MUX(1) | PORT_PCR_DSE_MASK
#define SWD_DIO_MODE PORTA_PCR13=(PORT_PCR_MUX(1) | PORT_PCR_PE_MASK | PORT_PCR_PS_MASK)
#define SWD_GPIO    PTA_BASE_PTR
#define SWD_CLK_PIN 12
#define SWD_DIO_PIN 13
